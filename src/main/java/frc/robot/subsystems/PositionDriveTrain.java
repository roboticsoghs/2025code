...
public class PositionDriveTrain extends SubsystemBase {
    // motors
    ...
    private final double SmartPositionP = 2.2; // prev value: 0.0011
    ...
    private void configurePIDControllers() {
        ...
        leftFrontConfig.closedLoop.pid(SmartPositionP, SmartPositionI, SmartPositionD);
        leftFrontConfig.closedLoop.maxMotion.maxAcceleration(maxAccel);
        leftFrontConfig.closedLoop.maxMotion.maxVelocity(maxVel);
        leftFrontConfig.closedLoop.velocityFF(SmartPositionFF);
        ...
        leftRearConfig.closedLoop.pid(SmartPositionP, SmartPositionI, SmartPositionD);
        leftRearConfig.closedLoop.maxMotion.maxAcceleration(maxAccel);
        leftRearConfig.closedLoop.maxMotion.maxVelocity(maxVel);
        leftRearConfig.closedLoop.velocityFF(SmartPositionFF);
        ...
        rightFrontConfig.closedLoop.pid(SmartPositionP, SmartPositionI, SmartPositionD);
        rightFrontConfig.closedLoop.maxMotion.maxAcceleration(maxAccel);
        rightFrontConfig.closedLoop.maxMotion.maxVelocity(maxVel);
        rightFrontConfig.closedLoop.velocityFF(SmartPositionFF);
        ...
        rightRearConfig.closedLoop.pid(SmartPositionP, SmartPositionI, SmartPositionD);
        rightRearConfig.closedLoop.maxMotion.maxAcceleration(maxAccel);
        rightRearConfig.closedLoop.maxMotion.maxVelocity(maxVel);
        rightRearConfig.closedLoop.velocityFF(SmartPositionFF);
     ...
     */
    public void setLeftSideMotorSpeed(double rotations) {
        // calculate the necessary rpm
        SmartDashboard.putNumber("Speed of left side(rpm): ", rotations);
        // Set rpm for left motors
        leftFrontPID.setReference(rotations, ControlType.kMAXMotionPositionControl);
    }

    /**
     * @param input percent input of speed from right joystick
     */
    public void setRightSideMotorSpeed(double rotations) {
        // calculate the necessary rpm
        SmartDashboard.putNumber("Speed of right side(rpm): ", rotations);
        // Set rpm for left motors
        rightFrontPID.setReference(-rotations, ControlType.kMAXMotionPositionControl);
    }
